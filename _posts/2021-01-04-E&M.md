...
excerpt: "Including an overview of Maxwell's equations, potentials, energy and momentum in EM fields, multipoles, fields in matter, Laplace's equation, the method of images, capacitance and inducatance, and radiation."
comments: false
---
<a name="toc"></a>
...
<div>\begin{gather}
	...
	\dv{P}{\Omega} = \frac{\mu_0}{16\pi^2 c}\qty|\vu{r}\times\vb*{\alpha}(\vb{r},\,t)|^2
\end{gather}</div>
